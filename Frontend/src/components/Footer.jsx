      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <Link to="/" className="block text-lg font-bold">E-Shop</Link>
            <p className="text-gray-400 mt-4">
              Your one-stop destination for all your shopping needs. Quality products, excellent service.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <address className="not-italic text-gray-400">
              ...
              <p>Retail District, Market City</p>
              <p className="mt-4">Email: <a href="mailto:info@eshop.com" className="hover:text-white">info@eshop.com</a></p>
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex flex-col md:flex-row gap-2 items-center">
              <span className="text-gray-400">Subscribe to our newsletter:</span>
              <div className="flex">
                <input 
                  type="email" 
                  placeholder="Your email" 
                  className="bg-gray-800 text-white px-4 py-2 rounded-l-md focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
                <button 
